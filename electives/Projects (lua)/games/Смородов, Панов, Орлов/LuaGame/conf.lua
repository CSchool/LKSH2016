--[[
Необходимо создать файл conf.lua, в которой необходимо создать функцию love.conf(t), 
в которой можно изменять те или иные параметры параметры игры
--]]
function love.conf(t)
    ...
    t.window.title = "SpaceInvaders"         -- The window title (string)
